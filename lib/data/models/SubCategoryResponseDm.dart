...
class SubCategoryResponseDm extends SubCategoryResponseEntity {
  ...
  SubCategoryResponseDm.fromJson(dynamic json) {
    ...
    metadata = json['metadata'] != null ? SubCategoryMetadataDm.fromJson(json['metadata']) : null;
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
        data?.add(SubCategoryDataDm.fromJson(v));
      });
    }
  }
...
class SubCategoryDataDm extends SubCategoryDataEntity {
  SubCategoryDataDm({
      super.id,
      super.name,
      super.slug,
  ...
  SubCategoryDataDm.fromJson(dynamic json) {
    id = json['_id'];
    name = json['name'];
    slug = json['slug'];
...
class SubCategoryMetadataDm extends SubCategoryMetadataEntity{
  SubCategoryMetadataDm({
      super.currentPage,
      super.numberOfPages,
      super.limit,
      super.nextPage,});

  SubCategoryMetadataDm.fromJson(dynamic json) {
